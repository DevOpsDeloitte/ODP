    ...
    public partial class EvaluationControl : System.Web.UI.UserControl
    {
        ...
        protected void renderEntitiesStudiedQuestions()
        {
            ...
            foreach (var question in questions)
            {
                ...
                StringBuilder row = new StringBuilder();
                row.AppendLine("<tr>");
                row.AppendLine("<td scope=\"row\" ng-click=\"showDescription('entitiesstudied-" + question.EntitiesStudiedID.ToString() + "')\">" + question.EntitiesStudiedID.ToString() + ". " + question.EntitiesStudied + "</td>");
                row.AppendLine("<td class=\"box-three\"><div outcome-box=\"mdata.entitiesstudied[" + question.EntitiesStudiedID + "]\" is-checked='" + getViewVals[0] + "'  show-coders='" + getCoderVals[0] + "' show-comparers='" + getComparerVals[0] + "' is-enabled='yes' " + " name=\"entitiesstudied-" + question.EntitiesStudiedID + "\" data-cat-id=\"entitiesstudied\" data-q-id =\"" + question.EntitiesStudiedID + "\"></div></td>");
        ...
        protected void renderStudySettingsQuestions()
        {
            ...
            foreach (var question in questions)
            {
                ...
                StringBuilder row = new StringBuilder();
                row.AppendLine("<tr>");
                row.AppendLine("<td scope=\"row\" ng-click=\"showDescription('studysetting-" + question.StudySettingID.ToString() + "')\">" + question.StudySettingID.ToString() + ". " + question.StudySetting + "</td>");
                row.AppendLine("<td class=\"box-three\"><div outcome-box=\"mdata.studysetting[" + question.StudySettingID + "]\"  is-checked='" + getViewVals[0] + "' show-coders='" + getCoderVals[0] + "' show-comparers='" + getComparerVals[0] + "' is-enabled='yes' " + " name=\"studysetting-" + question.StudySettingID + "\" data-cat-id=\"studysetting\" data-q-id =\"" + question.StudySettingID + "\"></div></td>");
        ...
        protected void renderPopulationFocusQuestions()
        {
            ...
            foreach (var question in questions)
            {
                ...
                StringBuilder row = new StringBuilder();
                row.AppendLine("<tr>");
                row.AppendLine("<td scope=\"row\" ng-click=\"showDescription('populationfocus-" + question.PopulationFocusID.ToString() + "')\">" + question.PopulationFocusID.ToString() + ". " + question.PopulationFocus + "</td>");
                row.AppendLine("<td class=\"box-three\"><div outcome-box=\"mdata.populationfocus[" + question.PopulationFocusID + "]\"  is-checked='" + getViewVals[0] + "' show-coders='" + getCoderVals[0] + "' show-comparers='" + getComparerVals[0] + "' is-enabled='yes' " + " name=\"populationfocus-" + question.PopulationFocusID + "\" data-cat-id=\"populationfocus\" data-q-id =\"" + question.PopulationFocusID + "\"></div></td>");
        ...
        protected void renderStudyDesignPurposeQuestions()
        {
            ...
            foreach (var question in questions)
            {
                ...
                StringBuilder row = new StringBuilder();
                row.AppendLine("<tr>");
                row.AppendLine("<td scope=\"row\" ng-click=\"showDescription('studydesignpurpose-" + question.StudyDesignPurposeID.ToString() + "')\">" + question.StudyDesignPurposeID.ToString() + ". " + question.StudyDesignPurpose + "</td>");
                row.AppendLine("<td class=\"box-three\"><div outcome-box=\"mdata.studydesignpurpose[" + question.StudyDesignPurposeID + "]\"  is-checked='" + getViewVals[0] + "' show-coders='" + getCoderVals[0] + "' show-comparers='" + getComparerVals[0] + "' is-enabled='yes' " + " name=\"studydesignpurpose-" + question.StudyDesignPurposeID + "\" data-cat-id=\"studydesignpurpose\" data-q-id =\"" + question.StudyDesignPurposeID + "\"></div></td>");
        ...
        protected void renderPreventionCategoryQuestions()
        {
            ...
            foreach (var question in questions)
            {
                ...
                StringBuilder row = new StringBuilder();
                row.AppendLine("<tr>");
                row.AppendLine("<td scope=\"row\" ng-click=\"showDescription('preventioncategory-" + question.PreventionCategoryID.ToString() + "')\">" + question.PreventionCategoryID.ToString() + ". " + question.PreventionCategory + "</td>");
                row.AppendLine("<td class=\"box-three\"><div outcome-box=\"mdata.preventioncategory[" + question.PreventionCategoryID + "]\"   is-checked='" + getViewVals[0] + "' show-coders='" + getCoderVals[0] + "' show-comparers='" + getComparerVals[0] + "' is-enabled='yes' " + " name=\"preventioncategory-" + question.PreventionCategoryID + "\" data-cat-id=\"preventioncategory\" data-q-id =\"" + question.PreventionCategoryID + "\"></div></td>");
