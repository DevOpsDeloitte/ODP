<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EvaluationControlB.ascx.cs" Inherits="ODPTaxonomyWebsite.Evaluation.Controls.EvaluationControlB" %>
        ...
        <table class="bordered zebra-striped" id="study-focus" class="study-focus">
            ...
            <thead>
                    <tr>
                            ...
                            <th scope="col" class="answer">A.4. Basic study focus<div class="icon open" ng-click="showDescription('studyfocuscategory-4')" ></div></th>
