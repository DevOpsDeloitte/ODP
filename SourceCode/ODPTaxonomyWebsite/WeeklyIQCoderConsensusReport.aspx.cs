...
{
    public partial class WeeklyIQCoderConsensusReport : System.Web.UI.Page
    {
        #region Fields
        private string filenameBase = "PACT-Coded Abstract Consensus List-";
        private string filename = "PACT-Coded Abstract Consensus List-MM-DD-YYYY.xlsx";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (isValidParams())
                {
                    ...
                    List<rpt_IQCode_Abstracts_Consensus_ByDateResult> rptList = null;
                    ...
                    while (m_startdate <= m_enddate)
                    {
                        ...
                        {
                            rptList = db.rpt_IQCode_Abstracts_Consensus_ByDate(l_startdate, l_startdate).ToList<rpt_IQCode_Abstracts_Consensus_ByDateResult>();
                        }

                        if (rptList.Count() != 0)
                        {
                            isData = true;
                            CreateExcelFile.CreateExcelDocument<rpt_IQCode_Abstracts_Consensus_ByDateResult>(rptList, null, l_tabname, ds);
                        }
