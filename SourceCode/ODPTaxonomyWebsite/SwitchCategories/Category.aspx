<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="ODPTaxonomyWebsite.SwitchCategories.Category" %>
               ...
               <Table style="border:none;box-shadow:none;" ID="Tbl" runat="server" >
                   ...
                   <asp:DropDownList ID="ddlCategory" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlCategory_Change"></asp:DropDownList>
                    ...
                    <td style="border:none;" > 
                         <p>
                        <asp:Label runat="server" style="color: green; font-size:24px;" ID="lbl_message"></asp:Label>
                        </p>
                    <div style="color: #000;font-size:18px;"><strong>Currently Active: <asp:Label runat="server"  ID="lbl_active_category"></asp:Label></strong></div><br />
                    <div style="color: #000;font-size:18px;"><strong>Change To Category: <asp:Label runat="server"  ID="lbl_category"></asp:Label></strong></div><br />
                    ...
                    <asp:Button runat="server" ID="btn_submit" Height="34px" Width="90px" Text="Submit"  OnClientClick="return alertify_confirm()"/> 
                     ...
                     <div style="float:right !important;"><asp:Button runat="server" ID="btn_reset" Height="34px"  Width="90px" Text="Reset" OnClick="btn_reset_Click" OnClientClick="reset_confirm()" /></div>
