    ...
    return {
        ...
        link: function (scope, elem, attrs) {
            ...
            if($rootScope.mode.indexOf("Consensus") != -1 && !scope.view.disabled /* && $rootScope.displaymode != "View" */)
            {
                if( attrs.showCoders != "" && attrs.showCoders !== undefined){
                     ...
                     if($rootScope.displaymode != "View" /*&& !scope.view.noInput*/)
                     {
                         if (scope.view.noInput === undefined || scope.view.noInput == false) {
        ...
        controller: function ( $scope, $element, $attrs) {
            ...
            $scope.updatestate = function () {
                if ($attrs.noInput !== undefined) return;
                //console.log("update state - no input  ::" + $attrs.noInput);
                // this works.
